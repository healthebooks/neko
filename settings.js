...
const collectionInfo = {
    name: "Neko Nation Pre sale",
    title: "NN MINT", // Title prefix (ex "Buy your {name}") - You can use {name} to insert the collection name
    date: "08.07.2022",
    socialMedia: {
...
const nftsInfo = {
    ...
    receiveAddress: "FQhPZwDeL9pDYzQqLOT5DmQPOLoRBJI3qdOjlnDdshaSO0auU7Dr7SD1OnZVKxR0" // leave empty if you want to use the same address 
}
